...
import {
  ...
  getSupplierList,
  getCorporateList
} from '@/api/consumableService/brandInfo'
...
const mockData = [
  ...
  },
  {
    ...
    brandCode: 'KN003',
    brandName: '肯纳',
    corporateName: '肯纳金属公司',
    createDept: '采购部',
    createTime: '2024-12-22 11:30:00',
    createUser: '孙采购',
    isDeleted: 0,
    phone: '0755-98765432',
    status: 'inactive',
    supplierName: '深圳肯纳工具有限公司',
    supplierUser: '周经理',
    tenantId: 'T001',
...
const handleDelete = (row) => {
  ElMessageBox.confirm(`确定要删除品牌 "${row.brandName}" 吗？`, '确认删除', {
