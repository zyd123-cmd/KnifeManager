    ...
    <div class="topSearchDiv">
      <el-form :inline="true" :model="formInline" ref="formInlineRes" class="demo-form-inline">
        ...
        <el-form-item label="员工角色:" prop="employeeRole">
          <el-select v-model="formInline.employeeRole" placeholder="请选择员工角色" clearable style="width: 150px;">
      ...
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="employeeRole" label="员工角色" align="center">
          <template #default="scope">
            <el-tag :type="scope.row.employeeRole === 'leader' ? 'warning' : 'primary'">
              {{ scope.row.employeeRole === 'leader' ? '组长' : '工人' }}
            </el-tag>
          </template>
        </el-table-column>
...
const resetAddForm = () => {
  Object.assign(addForm, {
    employeeName: '',
    employeeCode: '', // 重置时清空，在openAddDialog中会重新生成
    employeeRole: '',
    department: '',
    icCardNumber: '',
    phone: '',
...
const handleStatusChange = (row) => {
  ...
  ElMessageBox.confirm(`确定要将员工 ${row.employeeName} 设置为${actionText}状态吗?`, '提示', {
    confirmButtonText: '确定',
    cancelButtonText: '取消',
    type: 'warning'
  }).then(() => {
    console.log(`员工 ${row.employeeName} 状态变更为: ${newStatus}`)
...
const handleDelete = (row) => {
  ElMessageBox.confirm(`确定要删除员工 ${row.employeeName} 吗?`, '提示', {
    ...
    console.log(`删除员工: ${row.employeeName}`)
