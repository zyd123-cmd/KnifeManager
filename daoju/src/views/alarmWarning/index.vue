...
const handleExport = async () => {
  try {
    // 构造导出参数，使用下划线命名
    const exportParams = {
      loc_surplus: searchForm.locSurplus,
      alarm_level: searchForm.alarmLevel,
      device_type: searchForm.deviceType,
      cabinet_code: searchForm.cabinetCode,
      brand_name: searchForm.brandName,
      handle_status: searchForm.handleStatus
    }
    ...
    const res = await exportAlarmWarning(exportParams)
    // 处理导出响应
