    ...
    <div class="topSearchDiv">
      <el-form :inline="true" :model="formInline" ref="formInlineRes" class="demo-form-inline">
        ...
        <el-form-item label="刀具柜名称:" prop="cabinetList.cabinetName">
          <el-input v-model="formInline.cabinetList.cabinetName" placeholder="请出入刀具柜名称" clearable/>
        </el-form-item>
        ...
        <el-form-item label="刀具类型:" prop="cutterCode">
          <el-input v-model="formInline.cutterCode" placeholder="请出入刀具类型" clearable/>
        </el-form-item>
        <el-form-item label="刀具型号:" prop="cutterType">
          <el-input v-model="formInline.cutterType" placeholder="请出入刀具型号" clearable/>
        </el-form-item>
...
<!--    新增按钮、批量上传、下载模版-->
    ...
    <div class="tableDiv">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="cutterCode" label="刀具类型" align="center"/>
        <el-table-column prop="cutterType" label="刀具型号" align="center"/>
        <!-- 操作-->
...
const tableData = reactive([
  {
    ...
    createUser: "张工程师",//创建人
    cutterCode: "mill",//刀具类型
    cutterType: "R390-11T308M-PM",//刀具型号
    price: "285.50", //价格
    remark: "高精度铣刀，适用于钢材加工",
    images: [
      {
        name: 'cutter1.jpg',
  ...
  },
  {
    ...
    createUser: "李技师",//创建人
    cutterCode: "drill",//刀具类型
    cutterType: "880-D1200L20-03",//刀具型号
    price: "156.80", //价格
    remark: "硬质合金钻头，适用于不锈钢",
    images: [
      {
        name: 'cutter2.jpg',
  ...
  },
  {
    ...
    createUser: "王师傅",//创建人
    cutterCode: "turning",//刀具类型
    cutterType: "CNMG120408-QM",//刀具型号
    price: "98.30", //价格
    remark: "车削刀片，通用型"
  },
  {
    ...
    createUser: "陈主管",//创建人
    cutterCode: "boring",//刀具类型
    cutterType: "A25T-SCLCR09",//刀具型号
    price: "420.00", //价格
    remark: "内孔镗刀，高精度加工专用"
  },
  {
  ...
  },
  {
    ...
    createUser: "赵技师",//创建人
    cutterCode: "drill",//刀具类型
    cutterType: "DC160-05-08.500A1-WJ30EJ",//刀具型号
    price: "189.60", //价格
    remark: "整体硬质合金钻头"
  }
])
...
const submitAddForm = async () => {
  try {
    ...
    if (isEdit.value) {
      ...
      // 这里调用编辑接口
      // const response = await updateCutterHead(submitData)
      console.log('编辑数据:', submitData)
      ElMessage.success('编辑成功!')
    } else {
      // 新增模式
      // 这里调用新增接口
      // const response = await addCutterHead(submitData)
...
const submitUpload = async () => {
  ...
  try {
    ...
    // 这里调用上传接口
    // const response = await uploadBatchData(formData)
...
const onSubmit = () => {
  ...
  // 这里调用搜索接口
  // const response = await searchCutterHeads(searchParams)
