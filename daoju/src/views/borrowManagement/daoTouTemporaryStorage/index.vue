      ...
      >
        <el-row :gutter="20" v-if="isEdit">
          <el-col :span="12">
            <el-form-item label="暂存单号" prop="storageCode">
              <el-input
                v-model="borrowForm.storageCode"
                placeholder="系统自动生成"
                :disabled="true"
                readonly
              />
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="暂存人编号" prop="storageUser">
              <el-input
                v-model="borrowForm.storageUser"
                placeholder="当前用户编号"
                :disabled="true"
                readonly
              />
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="暂存数量" prop="quantity">
              <el-input-number
...
const tableData = reactive([
  ...
  {
    id: 5,
    storageCode: 'BOR20241227005',
    borrowerName: '钱七',
    storageUser: 5,
    brandName: '京瓷',
    cutterType: 'CCMT09T304-PM',
    quantity: 2,
    storageTime: '2024-12-26',
    expectedReturnDate: '2024-12-30',
    actualReturnDate: '',
  ...
  {
    id: 6,
    storageCode: 'BOR20241227006',
    borrowerName: '孙八',
    storageUser: 6,
    brandName: '住友',
    cutterType: 'WNMG080408-MS',
    quantity: 3,
    storageTime: '2024-12-25',
...
const generateStorageCode = () => {
  ...
  const existingCodes = tableData.filter(record =>
    record.storageCode && record.storageCode.startsWith(`BOR${today}`)
  )
...
const openBorrowDialog = () => {
  ...
  editId.value = null
  resetBorrowForm()
  borrowForm.storageCode = generateStorageCode()
  // 自动填充当前用户信息
  borrowForm.borrowerName = currentUser.employeeName
  borrowForm.storageUser = currentUser.employeeCode
...
const resetBorrowForm = () => {
  Object.assign(borrowForm, {
    ...
    storageUser: currentUser.employeeCode, // 默认为当前用户编号
    brandName: '',
    cutterType: '',
    quantity: 1,
    expectedReturnDate: '',
